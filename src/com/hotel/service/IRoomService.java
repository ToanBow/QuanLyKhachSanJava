...
public interface IRoomService {
    ...
    /**
    Thiết lập bảng giá linh hoạt: Theo giờ, ngày, tuần, tháng hoặc theo mùa/lễ hội. [cite: 18, 19]
     */
    void updatePricingPolicy(String roomTypeId, double dayPrice, double hourPrice);

    /**
    Quản lý bảo trì: Chuyển trạng thái sang "Đang sửa chữa" kèm lý do và thời gian dự kiến. [cite: 20]
     */
    void setMaintenance(String roomId, String reason, String expectedFinishDate);

    /**
    Xác nhận dọn xong: Đưa phòng từ trạng thái "Chưa dọn" về "Sẵn sàng". [cite: 13]
     */
